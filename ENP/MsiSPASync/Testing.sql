...
SELECT COUNT(*),'CHM_MSI_SPA_HEADER              ' name      FROM chm.CHM_MSI_SPA_HEADER union all
SELECT COUNT(*),'CHM_MSI_SPA_DISTRIBUTOR         ' name      FROM chm.CHM_MSI_SPA_DISTRIBUTOR union all 
SELECT COUNT(*),'CHM_MSI_SPA_INSTALLERS          ' name      FROM chm.CHM_MSI_SPA_INSTALLERS union all
SELECT COUNT(*),'CHM_MSI_SPA_GEO_DETAILS         ' name      FROM chm.CHM_MSI_SPA_GEO_DETAILS union all
SELECT COUNT(*),'CHM_MSI_SPA_UNIT_ACTIVATIONS    ' name      FROM chm.CHM_MSI_SPA_UNIT_ACTIVATIONS union all
SELECT COUNT(*),'CHM_MSI_SPA_SYSTEM_ATTACHMENTS  ' name      FROM chm.CHM_MSI_SPA_SYSTEM_ATTACHMENTS union all
SELECT COUNT(*),'CHM_MSI_SYS_SIZE_INCENTIVE      ' name      FROM chm.CHM_MSI_SYS_SIZE_INCENTIVE union all
SELECT COUNT(*),'CHM_MSI_SYS_SIZE_INCENTIVE_CHM  ' name      FROM chm.CHM_MSI_SYS_SIZE_INCENTIVE_CHM;
