...
,UNIQUE_KEY                           VARCHAR2(4000) 
    ...
    PROCEDURE MERGE_SPA_UNIT_ACTIVATION_DATA (P_IN_CHM_MSI_SPA_UNIT_ACTIVATIONS IN TBL_CHM_MSI_SPA_UNIT_ACTIVATIONS
...
,PRODUCT                       VARCHAR2(4000)                 
    ...
    PROCEDURE MERGE_SPA_SYS_SIZE_INCENTIVE_DATA (P_IN_CHM_MSI_SYS_SIZE_INCENTIVE IN TBL_CHM_MSI_SYS_SIZE_INCENTIVE
                                    ,P_IN_OIC_INSTANCE_ID    IN VARCHAR2);
...
,PRODUCT                             VARCHAR2(4000)
    ...
    PROCEDURE MERGE_CHM_MSI_SYS_SIZE_INCENTIVE_CHM_DATA(P_IN_CHM_MSI_SYS_SIZE_INCENTIVE_CHM IN TBL_CHM_MSI_SYS_SIZE_INCENTIVE_CHM
                                    ,P_IN_OIC_INSTANCE_ID    IN VARCHAR2
	);								
