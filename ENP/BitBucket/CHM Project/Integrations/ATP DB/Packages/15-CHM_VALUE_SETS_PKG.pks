CREATE OR REPLACE PACKAGE CHM_VALUE_SETS_PKG
    
    /*************************************************************************************************************************************************************************
    * TYPE                           : PL/SQL Package Specification                                                                                                                        *
    * PACKAGE NAME                   : CHM_VALUE_SETS_PKG                                                                                                                 *
    * PURPOSE                        : Package Specification FOR CHM VALUE SETSSYNC FROM FUSION                                                                                  *
...
AS
    ...
    TYPE TBL_VALUE_SETS IS
        TABLE OF REC_VALUE_SETS;
