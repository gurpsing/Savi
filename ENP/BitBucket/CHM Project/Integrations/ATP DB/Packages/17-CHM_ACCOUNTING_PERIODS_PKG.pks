CREATE OR REPLACE PACKAGE CHM_ACCOUNTING_PERIODS_PKG
    ...
    *************************************************************************************************************************************************************************/
AS
    TYPE REC_ACCOUNTING_PERIODS IS RECORD (
    ...
    TYPE TBL_ACCOUNTING_PERIODS IS
        TABLE OF REC_ACCOUNTING_PERIODS;
