CREATE OR REPLACE PACKAGE CHM_STATE_PROVINCE_PKG
    
    /*************************************************************************************************************************************************************************
    * TYPE                           : PL/SQL Package Specification                                                                                                          *
    * PACKAGE NAME                   : CHM_STATE_PROVINCE_PKG                                                                                                                *
    * PURPOSE                        : Package Specification FOR CHM STATE PROVINCE SYNC FROM FUSION                                                                         *
    ...
    *************************************************************************************************************************************************************************/
AS
    TYPE REC_STATE_PROVINCE IS RECORD (
    ...
    TYPE TBL_STATE_PROVINCE IS TABLE OF REC_STATE_PROVINCE;
