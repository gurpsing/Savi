  ...
  CREATE TABLE "CHM_MSI_CLAIM_REJECT_REASONS" 
   (	"REASON_ID" NUMBER, 
	"REASON_TYPE" VARCHAR2(100) NOT NULL ENABLE, 
	"BATCH_ID" NUMBER, 
	"CLAIM_LINE_ID" NUMBER, 
	"REASON_CODE" VARCHAR2(300) NOT NULL ENABLE, 
	"REASON_DESCRIPTION" VARCHAR2(4000) NOT NULL ENABLE, 
	"REASON_COMMENT" VARCHAR2(4000), 
	"ATTRIBUTE_TYPE" VARCHAR2(240), 
	...
	"IP_ADDRESS" VARCHAR2(4000) NOT NULL ENABLE, 
	"USER_AGENT" VARCHAR2(4000), 
	 PRIMARY KEY ("REASON_ID")
  USING INDEX  ENABLE
   ) ;

  CREATE INDEX "CHM_MSI_CLAIM_REJECT_REASONS_IDX1" ON "CHM_MSI_CLAIM_REJECT_REASONS" ("CLAIM_LINE_ID") 
  ;

  CREATE INDEX "CHM_MSI_CLAIM_REJECT_REASONS_IDX2" ON "CHM_MSI_CLAIM_REJECT_REASONS" ("BATCH_ID") 
  ;

  CREATE OR REPLACE EDITIONABLE TRIGGER "BIU_CHM_MSI_CLAIM_REJECT_REASONS" BEFORE
    INSERT OR UPDATE ON CHM_MSI_CLAIM_REJECT_REASONS
    FOR EACH ROW
BEGIN
    IF INSERTING THEN
        IF :NEW.REASON_ID IS NULL THEN
            :NEW.REASON_ID := CHM_CLAIM_REJECT_REASONS_SEQ.NEXTVAL;
        END IF;
...
/
ALTER TRIGGER "BIU_CHM_MSI_CLAIM_REJECT_REASONS" ENABLE;