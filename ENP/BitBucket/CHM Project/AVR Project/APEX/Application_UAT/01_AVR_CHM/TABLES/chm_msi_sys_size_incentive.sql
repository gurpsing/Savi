  ...
  CREATE TABLE "CHM_MSI_SYS_SIZE_INCENTIVE" 
   (	"CHM_MSI_SPA_SYS_SIZE_ID" NUMBER DEFAULT CHM.CHM_MSI_SPA_SYSTEM_SIZE_INCENTIVES_SEQ.NEXTVAL, 
	"ID" VARCHAR2(4000), 
	...
	"PRODUCT" VARCHAR2(4000), 
	 CONSTRAINT "CHM_MSI_SYS_SIZE_INCENTIVE_PK" PRIMARY KEY ("CHM_MSI_SPA_SYS_SIZE_ID")
  USING INDEX  ENABLE
   ) ;

  CREATE INDEX "CHM_MSI_SYS_SIZE_INCENTIVE_ID_IDX" ON "CHM_MSI_SYS_SIZE_INCENTIVE" ("ID") 
  ;

  CREATE INDEX "CHM_MSI_SYS_SIZE_SPA_IDX" ON "CHM_MSI_SYS_SIZE_INCENTIVE" ("SPA") 
  ;

  CREATE OR REPLACE EDITIONABLE TRIGGER "BIU_CHM_MSI_SPA_SYSTEM_SIZE_INCENTIVES_TRG" 
  BEFORE INSERT OR UPDATE ON "CHM_MSI_SYS_SIZE_INCENTIVE"
  FOR EACH ROW
   BEGIN
      IF INSERTING THEN
        IF :new.CHM_MSI_SPA_SYS_SIZE_ID  IS NULL THEN
            :new.CHM_MSI_SPA_SYS_SIZE_ID   := CHM_MSI_SPA_SYSTEM_SIZE_INCENTIVES_SEQ.NEXTVAL;
        END IF;
      ...
      ELSIF updating THEN
       ...
       EXCEPTION
  WHEN OTHERS THEN
    chm_msi_debug_api.log_msg(:new.CHM_MSI_SPA_SYS_SIZE_ID || ', ' || :new.ID, 'BIU_CHM_MSI_SPA_SYSTEM_SIZE_INCENTIVES_TRG', SQLERRM);
    END;

/
ALTER TRIGGER "BIU_CHM_MSI_SPA_SYSTEM_SIZE_INCENTIVES_TRG" ENABLE;
  CREATE OR REPLACE EDITIONABLE TRIGGER "AIU_CHM_MSI_SPA_SYSTEM_SIZE_INCENTIVES_TRG" AFTER
    INSERT OR UPDATE OR DELETE ON "CHM_MSI_SYS_SIZE_INCENTIVE"
    FOR EACH ROW
BEGIN
    IF inserting THEN
        INSERT INTO CHM_MSI_SYS_SIZE_INCENTIVE_AUDIT (
            chm_msi_spa_sys_size_audit_id,
            chm_msi_spa_sys_size_id,
            old_id,
            new_id,
            old_tier1_rebate_amount,
            new_tier1_rebate_amount,
            old_tier2_rebate_amount,
            new_tier2_rebate_amount,
            old_tier3_rebate_amount,
            new_tier3_rebate_amount,
            old_tier4_rebate_amount,
            new_tier4_rebate_amount,
            old_tier5_rebate_amount,
            new_tier5_rebate_amount,
            old_status,
            new_status,
            ...
            chm_msi_spa_system_size_incentives_audit_seq.NEXTVAL,
            :new.chm_msi_spa_sys_size_id,
            :old.id,
            :new.id,
            :old.tier1_rebate_amount,
            :new.tier1_rebate_amount,
            :old.tier2_rebate_amount,
            :new.tier2_rebate_amount,
            :old.tier3_rebate_amount,
            :new.tier3_rebate_amount,
            :old.tier4_rebate_amount,
            :new.tier4_rebate_amount,
            :old.tier5_rebate_amount,
            :new.tier5_rebate_amount,
            :old.status,
            :new.status,
...
END;
/
ALTER TRIGGER "AIU_CHM_MSI_SPA_SYSTEM_SIZE_INCENTIVES_TRG" ENABLE;